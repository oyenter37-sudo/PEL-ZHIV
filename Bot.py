    ...
    try:
        ...
        for _ in range(max_iterations):
            ...
            if msg.tool_calls:
                ...
                # Напоминаем модели использовать ТОЛЬКО результаты инструментов
                api_messages.append({
                    "role": "system",
                    "content": "ВАЖНО: Отвечай ТОЛЬКО на основе результатов инструментов выше. Не придумывай ничего от себя! Перескажи результат как ёж, но не добавляй выдуманные детали, правила, квесты или таблицы."
                })
